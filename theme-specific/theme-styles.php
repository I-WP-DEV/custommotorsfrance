...
if ( ! function_exists( 'briny_customizer_get_css' ) ) {

	function briny_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = briny_customizer_add_theme_fonts( $fonts );
...
.briny_tabs .briny_tabs_titles li a, .more-link {
...
CSS;
			$rez          = apply_filters( 'briny_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = briny_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'briny_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( briny_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = briny_get_scheme_colors( $s );
					}
...
dt, mark, ins {	/* not 'i', because it used as icons container */
	color: {$colors['text_dark']};
}
s, strike, del {	
...
blockquote dt, blockquote b, blockquote strong, blockquote i, blockquote mark, blockquote ins {	
	color: {$colors['text_dark']};
}
...
.widget.widget_search form label input[type="search"]{
...
.widget.widget_search form label input[placeholder]::placeholder{color: {$colors['input_light']};}
.widget.widget_search form label input[placeholder]::-webkit-input-placeholder{color: {$colors['input_light']};}
.widget.widget_search form label input[placeholder]::-moz-placeholder{color: {$colors['input_light']};}
.widget.widget_search form label input[placeholder]:-ms-input-placeholder{
    color: {$colors['input_light']};
}
...
.sc_button_bordered:not(.sc_button_bg_image):hover, .wp-block-button.is-style-outline > .wp-block-button__link:hover {
	color:{$colors['text_hover']} !important;
...
.woocommerce input.button.alt, .related_wrap.related_style_classic .post_header p .more-link,
.wp-block-button:not(.is-style-outline)>.wp-block-button__link, .sc_button.sc_button_simple.sc_courses_item_button{
	color: {$colors['inverse_link']};
...
.related_wrap.related_style_classic .post_header p .more-link:focus,
.related_wrap.related_style_classic .post_header p .more-link:hover,
...
.sc_button.sc_button_simple.sc_courses_item_button:hover,
.sc_button.sc_button_simple.sc_courses_item_button:focus{
	color: {$colors['inverse_text']}!important;
...
.post_item.sticky.post_layout_excerpt {
     background-color: {$colors['text_dark']};
}
...
.post_item.sticky .post_content_excerpt{
    background-color: {$colors['text_dark']};
    color: {$colors['input_light']};
}
.post_item.sticky .post_content_excerpt .post_title a{
    color: {$colors['alter_bg_color']};
}
.post_item.sticky .post_content_excerpt .post_title a:hover{
    color: {$colors['text_link']};
}

.post_item.sticky .post_content_excerpt .post_date a{
    color: {$colors['input_light']};     
}
.post_item.sticky .post_content_excerpt .post_date a:hover{
    color: {$colors['text_hover']};     
}
/* Custom layouts
--------------------------------- */
...
a.sc_layouts_iconed_text_link:hover .sc_layouts_iconed_text_line2{
    color: {$colors['text_link']};
}
...
.sc_layouts_row_type_compact .sc_layouts_iconed_text_link .sc_layouts_item_details_line2:hover,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_iconed_text_link .sc_layouts_item_details_line2:hover{
    color: {$colors['text_hover']};
}
...
.top_panel .sc_layouts_row_type_compact .sc_layouts_menu .sc_layouts_menu_nav > li > a {
	color: {$colors['text_dark']};
}
.top_panel .scheme_self.sc_layouts_row_type_compact .sc_layouts_menu .sc_layouts_menu_nav > li > a {
	color: {$colors['text_dark']};
}
...
.briny_tabs .briny_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.briny_tabs .briny_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .briny_tabs .briny_tabs_titles li.ui-state-active a {
	color: {$colors['alter_bg_color']};
	background-color: {$colors['alter_dark']};
}
...
.post_item.product .post_meta_item.post_categories a {
	color: {$colors['text']};
}

.post_meta_item.post_categories a:hover,
.post_item.product .post_meta_item.post_categories a:hover {
	color: {$colors['text_hover']};
}
...
.single.single-post .post_item_single, .related_wrap.related_style_classic .post_header, .comment_body{
   background-color: {$colors['alter_bg_color']};	 
}
...
.post_item_single .post_content > .post_meta_single .post_tags .post_meta_label, .socials_share .socials_caption{
    color: {$colors['text']};
}
...
.comment-form .trx_addons_message_box.trx_addons_message_box_error, form .error_field{
    border-color: {$colors['text_link']}!important;
}
...
.widget.widget_recent_posts .recent_post_content, .widget_product_tag_cloud .tagcloud, .widget_tag_cloud .tagcloud, .widget_banner, .widget_recent_comments ul, .woocommerce .widget_product_categories .product-categories,
.woocommerce .widget_price_filter .price_slider_wrapper, .widget_shopping_cart .widget_shopping_cart_content{
    background-color: {$colors['alter_bd_hover']};
}
...
.widget_calendar caption, .widget_calendar table, .widget_calendar .wp-calendar-nav,
.wp-block-calendar caption, .wp-block-calendar table, .wp-block-calendar .wp-calendar-nav {
    background-color: {$colors['alter_bg_color']};
}
...
.sidebar .widget_calendar td#prev a:before, .sidebar .widget_calendar td#next a:before,
.sidebar .wp-block-calendar td#prev a:before, .sidebar .wp-block-calendar td#next a:before,
.sidebar .widget_calendar .wp-calendar-nav-prev a:before, .sidebar .widget_calendar .wp-calendar-nav-next a:before,
.sidebar .wp-block-calendar .wp-calendar-nav-prev a:before, .sidebar .wp-block-calendar .wp-calendar-nav-next a:before {
	background-color: {$colors['alter_bg_color']};
}
...
.single.single-post .post_item_single .post_content .post_tags a:hover{
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_hover']};
}
.scheme_self.sidebar .sc_edd_details .downloads_page_tags .downloads_page_data > a:hover,
...
.footer_wrap .widget.wp-widget-nav_menu ul li a{
    color: {$colors['inverse_light']};
}
.footer_wrap .widget.wp-widget-nav_menu ul li a:hover{
    color: {$colors['text_hover']};
}
...
.footer_wrap.footer_custom_footer-short a{
	color: {$colors['text_dark']};
}
.footer_wrap.footer_custom_footer-short a:hover {
	color: {$colors['text_hover']};
}
.footer_wrap.footer_custom_footer-boating a { 
	color: {$colors['inverse_link']};
}
.footer_wrap.footer_custom_footer-boating a:hover {
	color: {$colors['text_hover']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'briny_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'briny_filter_prepare_css', $css_str, $remove_spaces );
	}
}
