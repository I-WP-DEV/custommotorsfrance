...
<?php
	...
	if ( is_singular( 'post' ) || is_singular( 'attachment' ) ) {
		...
		if ( 'default' === $briny_post_thumbnail_type && 'default' !== $briny_post_header_position ) {
			?>
			...
			<?php
		} elseif ( 'default' !== $briny_post_thumbnail_type && 'default' === $briny_post_header_position ) {
			// Post title and meta
			briny_show_post_title_and_meta();
		}
	}
	...
	<div class="post_content post_content_single entry-content" itemprop="mainEntityOfPage">
		...
		do_action( 'briny_action_before_post_pagination' );
		...
		if ( is_single() && ! is_attachment() ) {
			...
			<div class="post_meta post_meta_single">
				...
				// Post taxonomies
				the_tags( '<span class="post_meta_item post_tags"><span class="post_meta_label">' . esc_html__( 'Tags:', 'briny' ) . '</span> ', ' ', '</span>' );

				// Share
				if ( briny_is_on( briny_get_theme_option( 'show_share_links' ) ) ) {
