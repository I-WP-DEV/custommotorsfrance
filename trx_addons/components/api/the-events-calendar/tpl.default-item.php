...
<div class="sc_events_item">
    <div class="sc_events_item_date">
        <?php
        trx_addons_show_layout(date_i18n(get_option('date_format'), strtotime($dt)), '<span class="sc_events_item_date_item">', '</span>');
        ?>
    </div>
	<?php
		...
		<div class="sc_events_item_header">
            ...
            <div class="sc_events_item_meta">
				<span class="sc_events_item_meta_item sc_events_item_meta_date">
                    <span class="label"> <?php echo esc_html__('Time:','briny') ?> </span>
                    <?php
					if ($dt == $dt2) {
						if ( $tm == null ) {
							...
							trx_addons_show_layout($tm2, '<span class="sc_events_item_meta_time_end">', '</span>');
						}
					} else {
						if ( $tm == null ) {
                            trx_addons_show_layout($tm, '<span class="sc_events_item_meta_time_start">', '</span>');
				...
				?></span>
                <div class="sc_events_item_price">
                    <span class="label"> <?php echo esc_html__('Cost:','briny') ?> </span>
