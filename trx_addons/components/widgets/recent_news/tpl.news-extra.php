...
?><article
	<?php post_class( 'post_item news_extra post_layout_'.esc_attr($style).' post_format_'.esc_attr($post_format) ); ?>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												'post_info' => '<div class="post_info">'
																...
																. '<h5 class="post_title entry-title"><a href="'.esc_url(get_permalink()).'" rel="bookmark">' . wp_kses( get_the_title(), 'briny_kses_content' ) . '</a></h5>'
																. ( in_array( get_post_type(), array( 'post', 'attachment' ) ) 
																		...
																		: '')
																. '</div>',
                                                'thumb_size'    => trx_addons_get_thumb_size( (int) $columns == 2 ? 'tours' : 'big' ) ,
