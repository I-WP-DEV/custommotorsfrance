...
WordPress version: required at least 4.5, tested up to 5.2.1
...
Please install and activate it before starting to use the theme Briny.
...
Theme documentation is available on http://briny.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Briny is Fontello.
