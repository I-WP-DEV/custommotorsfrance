...
if ( ! function_exists( 'briny_trx_addons_add_theme_vars' ) ) {
	add_filter( 'briny_filter_add_theme_vars', 'briny_trx_addons_add_theme_vars', 10, 2 );
	function briny_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'briny_trx_addons_get_css' ) ) {
	add_filter( 'briny_filter_get_css', 'briny_trx_addons_get_css', 10, 2 );
	function briny_trx_addons_get_css( $css, $args ) {
...
.trx_addons_emotions_active:before {
     color: {$colors['text_link']};
}
...
.sc_tours_item .sc_tour_wrapper .sc_tours_item_subtitle a:after, .sc_blogger_item.type-cpt_tours .post_info_bl a:after{
    background-color:{$colors['text_hover']};
}
.sc_tours_item .sc_tour_wrapper .sc_tours_item_subtitle a:hover:after, .sc_blogger_item.type-cpt_tours .post_info_bl a:hover:after{
    background-color:{$colors['text_link']};
}
...
.sc_blogger_item_default_classic_2 .sc_item_featured .post_info_bl .post_categories a, .sc_blogger_item_default_classic_2.type-cpt_boats .sc_item_featured .post_info_bl a{
     color: {$colors['alter_bg_color']};
}
.sc_blogger_item_default_classic_2 .sc_item_featured .post_info_bl .post_categories a:after, .sc_blogger_item_default_classic_2.type-cpt_boats .sc_item_featured .post_info_bl a:after{
    background-color: {$colors['text_hover']};
}
.sc_blogger_item_default_classic_2 .sc_item_featured .post_info_bl .post_categories a:hover:after, .sc_blogger_item_default_classic_2.type-cpt_boats .sc_item_featured .post_info_bl a:hover:after{
    background-color: {$colors['text_link']};
}
...
.sc_blogger.sc_blogger_classic .post_item{
...
.sc_icons_default div[class*="trx_addons_column-"]:first-child{
    background-color: {$colors['text_hover']};
}
.sc_icons_default div[class*="trx_addons_column-"]:nth-child(2n){
    background-color: {$colors['text_link3']};
}
.sc_icons_default div[class*="trx_addons_column-"]:nth-child(3n){
    background-color: {$colors['extra_bd_hover']};
}
.sc_icons_default div[class*="trx_addons_column-"] .sc_icons_item .sc_icons_icon{
    color: {$colors['inverse_text']};
}
.sc_icons_default div[class*="trx_addons_column-"] .sc_icons_item .sc_icons_item_title{
    color: {$colors['inverse_text']};
}
.sc_icons_default div[class*="trx_addons_column-"] .sc_icons_item .sc_icons_item_description a,
.sc_icons_default div[class*="trx_addons_column-"] .sc_icons_item .sc_icons_item_description{
    color: {$colors['inverse_text']};
}
.sc_icons_default div[class*="trx_addons_column-"] .sc_icons_item .sc_icons_item_description a:hover{
    color: {$colors['text_hover']};
}
...
.sc_icons.sc_icons_modern div[class*="trx_addons_column-"]:hover{
     background-color: {$colors['bg_color']};
}
...
.sc_icons.sc_icons_decoration .sc_icons_item_title,
.sc_icons.sc_icons_decoration .sc_icons_icon{
    color: {$colors['text_dark']};
}
...
.sc_price_item_price .sc_price_item_price_before, .sc_price_item_price .sc_price_item_price_after{
    color:{$colors['text_hover']};
}
...
.scheme_self.sc_price.sc_price_default .sc_price_item{
    background-color: {$colors['bg_color']}; 
}
...
.float_icon_left .sc_services_default div[class*="trx_addons_column-"]:nth-child(2n+1) .sc_services_item{
    background:{$colors['extra_bd_hover']}!important;
...
.float_icon_left .sc_services_default div[class*="trx_addons_column-"]:nth-child(2n) .sc_services_item .sc_services_item_content,
.float_icon_left .sc_services_default div[class*="trx_addons_column-"]:nth-child(2n+1) .sc_services_item .sc_services_item_content,
.float_icon_left .sc_services_default div[class*="trx_addons_column-"]:first-child .sc_services_item .sc_services_item_content{
     background:transparent!important;
}

.sc_services_default div[class*="trx_addons_column-"]:nth-child(2n) .sc_services_item_content{
   background: linear-gradient(227deg, {$colors['text_link3']}, {$colors['extra_bg_color']}, {$colors['text_hover']});
}
.sc_services_default div[class*="trx_addons_column-"]:nth-child(2n+1) .sc_services_item_content{
     background: linear-gradient(227deg, {$colors['extra_bg_color']}, {$colors['text_hover']}, {$colors['text_link3']});
}
.sc_services_default div[class*="trx_addons_column-"]:first-child .sc_services_item_content{
    background: linear-gradient(227deg, {$colors['text_link3']}, {$colors['text_hover']}, {$colors['extra_bg_color']});
}
.sc_services_default .sc_services_item_content *{
    color: {$colors['inverse_text']};
}
.sc_services_default .sc_services_item .sc_services_item_title a:hover{
     color: {$colors['alter_bg_color_07']};
}
...
.sc_services_chess .sc_services_item:nth-child(2n){
   background: linear-gradient(227deg, {$colors['text_link3']}, {$colors['extra_bg_color']}, {$colors['text_hover']});
}
.sc_services_chess .sc_services_item:nth-child(2n+1){
     background: linear-gradient(227deg, {$colors['extra_bg_color']}, {$colors['text_hover']}, {$colors['text_link3']});
}
.sc_services_chess .sc_services_item:first-child{
    background: linear-gradient(227deg, {$colors['text_link3']}, {$colors['text_link3']}, {$colors['extra_bg_color']});
}
...
.single.single-cpt_tours .social_item .social_icon{
    color: {$colors['inverse_link']};
	background-color: {$colors['inverse_dark']};
}
.single.single-cpt_tours .social_item .social_icon:hover{
    color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
.socials_wrap .social_item .social_icon,
...
.scheme_self.footer_wrap .socials_wrap .social_item, .footer_wrap .socials_wrap .social_item{
    border-color:{$colors['bd_color']};
}
...
header .sc_layouts_row_type_compact .socials_wrap .social_item .social_icon.social_icon_twitter{
    background-color: {$colors['text_link3']}!important;	
}
header .sc_layouts_row_type_compact .socials_wrap .social_item .social_icon.social_icon_instagramm{
    background-color: {$colors['text_link']}!important;	
}
header .sc_layouts_row_type_compact .sc_socials_default .socials_wrap .social_item .social_icon:hover{
    background-color: {$colors['alter_bg_color']}!important;	
}
...
/* Title */
.sc_title.sc_title_decoration .sc_title_title .sc_item_title_text:after, .sc_item_title.sc_item_title_style_decoration .sc_item_title_text:after{
    color: {$colors['text_hover']};
}
...
.sc_layouts_search .search_style_normal form .search_field, .single-cpt_tours .related_wrap{
    border-color: {$colors['text_dark_015']}!important;
}
.sc_layouts_search .search_style_normal form .search_submit{
    background-color: {$colors['bg_color']};
}
.sc_layouts_search .search_style_normal form .search_submit:hover{
    background-color: {$colors['bg_color']};
}
.scheme_self .sc_layouts_search .search_style_normal form .search_submit,
.scheme_self .sc_layouts_search .search_style_normal form .search_submit:hover{
