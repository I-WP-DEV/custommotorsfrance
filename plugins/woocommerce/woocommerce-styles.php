...
if ( ! function_exists( 'briny_woocommerce_get_css' ) ) {
	add_filter( 'briny_filter_get_css', 'briny_woocommerce_get_css', 10, 2 );
	function briny_woocommerce_get_css( $css, $args ) {
...
.post_item.product .post_meta_item.post_categories{
	{$fonts['p_font-family']}
	{$fonts['p_font-size']}
	{$fonts['p_font-weight']}
	{$fonts['p_font-style']}
...
.widget_shopping_cart .woocommerce-mini-cart__buttons > a.checkout{
   background: linear-gradient(to right,	{$colors['text_hover']} 50%, {$colors['extra_bd_hover']} 50%) no-repeat scroll right bottom / 210% 100% {$colors['extra_bg_color']} !important;
}
.widget_shopping_cart .woocommerce-mini-cart__buttons > a.checkout:hover{
    background-position: left bottom !important; color: {$colors['inverse_hover']} !important;
...
.single-product ul.products li.product .post_data .price del span.amount {
	color: {$colors['text_hover']}!important;
}
.single-product ul.products li.product .post_data .price ins span.amount {
	color: {$colors['inverse_text']}!important;
}
...
/* Shop mode selector */
.briny_shop_mode_buttons a {
	color: {$colors['text_hover']};
}
.briny_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
.shop_mode_thumbs .briny_shop_mode_buttons a.woocommerce_thumbs,
...
.sc_layouts_cart_widget .widget_shopping_cart .widget_shopping_cart_content .mini_cart_item a:not(.remove){
    color: {$colors['text_dark']};
}
.sc_layouts_cart_widget .widget_shopping_cart .widget_shopping_cart_content .mini_cart_item a:not(.remove):hover{
    color: {$colors['text_link']};
}
