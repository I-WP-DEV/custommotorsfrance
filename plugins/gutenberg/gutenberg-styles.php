...
if ( ! function_exists( 'briny_gutenberg_add_theme_vars' ) ) {
	add_filter( 'briny_filter_add_theme_vars', 'briny_gutenberg_add_theme_vars', 10, 2 );
	function briny_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'briny_gutenberg_get_css' ) ) {
	add_filter( 'briny_filter_get_css', 'briny_gutenberg_get_css', 10, 2 );
	function briny_gutenberg_get_css( $css, $args ) {
